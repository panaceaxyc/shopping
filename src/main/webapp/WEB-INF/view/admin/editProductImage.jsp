                                ...
                                <c:forEach items="${productImages}" var="pi">
                                    <tr>
                                        ...
                                        <td><img class="col-md-8"
                                                 src="${pageContext.request.contextPath}/static/img/product/${pi.product_id}/${pi.id%5==0?5:pi.id%5}.jpg"
                                                 onerror="this.src='${pageContext.request.contextPath}/static/img/product/error.png'"></td>
                                        <td class="col-md-5">
