                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${orders}" var="o">
                                        <tr>
                                            <%--<td>${o.id}</td>--%>
                                            <td>${o.order_code}</td>
                                            <td>${o.province} ${o.city} ${o.county}  ${o.detailAddress}</td>
                                            <%--<td>${o.post}</td>--%>
                                           ...
                                           <%-- <td>${o.user_message}</td>--%>
                                            ...
                                            <td><fmt:formatDate type="date"
                                                                value="${o.create_date}" /></td>
                                            <td><fmt:formatDate type="date"
                                                                value="${o.pay_date}" /></td>
                                            <td><fmt:formatDate type="date"
                                                                value="${o.delivery_date}" /></td>
                                            <td><fmt:formatDate type="date"
                                                                value="${o.pay_date}" /></td>
                                            <td>
                                                ...
                                                <c:if test="${o.status eq 'finish'}">
                                                    完成
                                                </c:if>
                                                <c:if test="${o.status eq 'waitDelivery'}">
                                                    等待发货
                                                </c:if>
                                            </td>
                                            <td>
                                                <%--<form action="updateOrder" role="form">--%>
                                                    ...
                                                    <input type="hidden" name="addressid" value="${oid}">
