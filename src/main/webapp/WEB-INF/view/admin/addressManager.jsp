    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a href="${pageContext.request.contextPath}/admin/"><i class="fa fa-link"></i> 推荐链接管理</a>
                </li>
                <li>
                    <a href="${pageContext.request.contextPath}/admin/carousel"><i class="fa fa-camera"></i>首页轮播图管理</a>
                </li>
                <li>
                    <a  class="active-menu"  href="${pageContext.request.contextPath}/admin/toAddress"><i class="fa fa-barcode"></i>管理收货地址</a>
                </li>
            </ul>
        </div>
                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <c:forEach items="${users}" var="u">
                                        <tr>
                                            <td>${u.id}</td>
                                            <td>${u.name}</td>
                                            <td><a href="${pageContext.request.contextPath}/admin/listAddress?userId=${u.id}"><span class="glyphicon glyphicon-edit"></span></a></td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
                                </table>
