    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a  class="active-menu"  href="${pageContext.request.contextPath}/admin/carousel"><i class="fa fa-camera"></i>首页轮播图管理</a>
                </li>
            </ul>
        </div>
                                    ...
                                    <c:forEach items="${cc}" var="carousel">
                                        <tr>
                                            ...
                                            <td width="500">
                                                ...
                                                <img src="${pageContext.request.contextPath}/static/${carousel.images}" alt="这是第${id}张图"
                                                    width="500" height="200"
                                                />
                                            </td>
                                            <td>
                                                <div class="col-md-3">
                                                    <a href="${pageContext.request.contextPath}/admin/editCarouseImages" class="btn btn-success">修改</a>
                                                </div>
                                            </td>
                                        </tr>
                                    </c:forEach>
