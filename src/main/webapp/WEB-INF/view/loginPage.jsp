...
<div class="mallPage" id="mallPage">
    <div class="header">
        <a href="${pageContext.request.contextPath}/home">
            <img src="${pageContext.request.contextPath}/static/img/fore/tmallLogo.png" class="tm-logo">
        </a>
    </div>
</div>
...
<style>
    ...
    div.field span.loginInputIconx {
        margin: 0px;
        background-color: #CBCBCB;
        width: 40px;
        height: 40px;
    ...
    $(function(){
        ...
        $("form.loginForm").submit(function(){
            if(0==$("#name").val().length){
                ...
                $("div.loginErrorMessageDiv").show();
                return false;
            }else if(0==$("#confirmlogo").val().length){
            ...
            <div class="static-form">
                ...
                <form action="/login" class="loginForm" method="post">
                    ...
                    <div class="field">
                        ...
                        <input style="width: 165px;" type="text" class="form-control" id="confirmlogo"
                               name="confirmlogo" placeholder="验证码">&nbsp;&nbsp;
                        <img src="${pageContext.request.contextPath}/verificationcodeimg" id="code" onclick="reloadcode()"
                             style="cursor: pointer;" alt="看不清楚,换一张" width="70" height="35">
                    </div>
                    ...
                    <div style="margin-top: 20px;">
                        <a href="registerPage" class="pull-left">免费注册</a>
                        <a onclick="javascript:history.go(-1)" class="pull-right">返回</a>
                    </div>
