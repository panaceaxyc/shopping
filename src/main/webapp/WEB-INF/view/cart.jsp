...
<%@include file="include/mini-search_cart.jsp" %>
<style>
    div.cartDiv {
        max-width: 1013px;
        margin: 10px auto;
...
<script>
    ...
    $(function () {
        ...
        $("a.deleteOrderItem").click(function () {
            ...
            var deleteProductName = $(".cartProductLink").val();
            var orderItemId = $(this).attr("orderItemId")
            deleteOrderItemid = orderItemId;
            /*$("#deleteConfirmModal").modal('show');*/
            swal(
                {title:"您确定要移除"+deleteProductName+"吗?",
                    text:"是否确认移除?",
                    type:"warning",
        ...
        $("img.cartProductItemIfSelected").click(function () {
            ...
            if ("selectit" == selectit) {
                $(this).attr("src", "/static/img/fore/cartNotSelected.png");
                $(this).attr("selectit", "false")
                $(this).parents("tr.cartProductItemTR").css("background-color", "#fff");
            }
            else {
                $(this).attr("src", "/static/img/fore/cartSelected.png");
        ...
        $("img.selectAllItem").click(function () {
            var selectit = $(this).attr("selectit")
            if ("selectit" == selectit) {
                $("img.selectAllItem").attr("src", "/static/img/fore/cartNotSelected.png");
                ...
                $("img.selectAllItem").attr("src", "/static/img/fore/cartSelected.png");
        ...
        <table class="cartProductTable">
            ...
            <tr>
                <th class="selectAndImage">
                    <img selectit="false" class="selectAllItem" src="/static/img/fore/cartNotSelected.png">
                    全选
                ...
                <tr orderItemId="${oi.id}" class="cartProductItemTR">
                    <td>
                        <img selectit="false" orderItemId="${oi.id}" class="cartProductItemIfSelected"
                             src="${pageContext.request.contextPath}/static/img/fore/cartNotSelected.png">
                        <a style="display:none" href="#nowhere"><img src="/static/img/fore/cartSelected.png"></a>
                        <img class="cartProductImg"
                             src="${pageContext.request.contextPath}/static/img/${oi.product.images}">
                    </td>
                    <td>
                        <div class="cartProductLinkOutDiv">
                            ...
                            <div class="cartProductLinkInnerDiv">
                                <img src="/static/img/fore/creditcard.png" title="支持信用卡支付">
                                <img src="/static/img/fore/7day.png" title="消费者保障服务,承诺7天退货">
                                <img src="/static/img/fore/promise.png" title="消费者保障服务,承诺如实描述">
                            </div>
                        </div>
