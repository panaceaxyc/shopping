...
<link href="${pageContext.request.contextPath}/static/assets/css/blog.css" rel="stylesheet">
<style>
    .bigImg {
        width: 418px;
        height: 418px;
    ...
    div.infoInimgAndInfo div.productPriceDiv {
        background-image: url(${pageContext.request.contextPath}/static/img/fore/priceBackground.png);
        height: 85px;
        padding: 10px;
        color: #666666;
    }
...
<div class="product">
    <div class="imgAndInfo">
        <div class="imgInimgAndInfo">
            <img class="bigImg" src="${product.images}">
            <%--<img class="bigImg" src="${pageContext.request.contextPath}/static/img/${product.images}">--%>
            <div class="smallImageDiv">
                <c:forEach items="${productImages}" var="images">
                    <img class="smallImg" src="${pageContext.request.contextPath}/static/img/${images.path}" bigImgURL="${pageContext.request.contextPath}/static/img/${images.path}">
        ...
        <div class="infoInimgAndInfo">
            ...
            <div class="productNumber">
                ...
                <input type="text" id="number" value="1" class="productNumberSetting">
                    ...
                    <span class="updown">
                       <img src="${pageContext.request.contextPath}/static/img/fore/increase.png">
                    </span>
					</a>
					<span class="updownMiddle"> </span>
					<a class="decreaseNumber" href="#nowhere">
						<span class="updown">
                        <img src="${pageContext.request.contextPath}/static/img/fore/decrease.png">
                    </span>
					</a>
					</span>
					件</span>
            ...
            <script>
                ...
                function buyLink() {
                    window.location.href = "/buyone?product_id="+${product.id}+"&number=" + $("#number").val();
                }
            </script>
            <div class="buyDiv">
                <%--<c:set var="number" scope="page" value="${('#number').val()}"--%>
                <a  onclick="javascript:return buyLink()" class="buyLink">
...
<style>
    ...
    a.selected:after {
        content: "";
        display: block;
        border-color: #13CFCF transparent transparent;
        border-style: solid;
        border-width: 5px;
        width: 0;
        height: 0;
    ...
    <div class="productReviewTopPart">
        ...
        <div class="data_list">
            <div class="data_list_title">
                <img src="${pageContext.request.contextPath}/static/img/image/publish_comment_icon.png">
                发表评论 (温馨提示: 每发表一次评论,会员积分+3分哦!)
            </div>
            <div class="publish_comment">
                ...
                <div class="verCode">
                    ...
                    &nbsp; <img src="${pageContext.request.contextPath}/verificationcodeimg"
                                id="code" title="换一张试试" onclick="loadimage()"
                                style="cursor: pointer;"
                                width="60" height="40"/>
                </div>
                <div class="publishButton">
                    <button id="saveButton" class="btn btn-primary" type="button">发表评论</button>
                </div>
            </div>
            ${msg}
        </div>
    ...
    <script type="text/javascript">
        ...
        $("#saveButton").click(function () {
            ...
            if (content == null || content == '') {
                ...
                window.location="${pageContext.request.contextPath}/admin/Reviewsave?content="+content+"&imageCode="+imageCode+"&product_id=${product.id}";
