    ...
    <div class="searchProducts">
        ...
        <style>
            ...
            .productStatus .ww-light a {
                background: url(static/img/fore/ww-online.png) center center no-repeat !important;
                ...
                <div class="product-iWrap">
                    <div class="productImg-wrap">
                        <a class="productImg" href="/showProduct?product_id=${p.id}">
                            <img src="${pageContext.request.contextPath}/static/img/${p.images}"/><%--${p.id}--%>
                        </a>
                    </div>
                    <div style="clear: both;"></div>
        ...
        <style>
            .nrt {
                background: url(/static/img/fore/no-product.png) 35px center no-repeat #fff8f6;
                color: #595959;
                margin-bottom: 10px;
