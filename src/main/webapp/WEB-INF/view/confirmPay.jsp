...
<div class="confirmPayPageDiv">
    ...
    <div class="confirmPayOrderItemDiv">
        ...
        <table class="confirmPayOrderItemTable">
            ...
            <c:forEach items="${order.orderItems}" var="oi">
                <tr>
                    <td><img width="50px" src="${pageContext.request.contextPath}/static/img/product/1/1.jpg"></td>
    ...
    <div class="confirmPayOrderDetailDiv">
        ...
        <table class="confirmPayOrderDetailTable">
            <tr>
                <td>订单编号：</td>
                <td>${order.order_code} <img width="23px" src="${pageContext.request.contextPath}/static/img/fore/confirmOrderTmall.png"></td>
            </tr>
            <tr>
                <td>卖家昵称：</td>
                <td>青橙商铺 <span class="confirmPayOrderDetailWangWangGif"></span></td>
            </tr>
            <tr>
                <td>收货信息：</td>
