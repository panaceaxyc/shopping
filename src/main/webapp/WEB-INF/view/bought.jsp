        ...
        <c:forEach items="${orders}" var="o">
            <table class="orderListItemTable" orderStatus="${o.status}" oid="${o.id}">
                <tr class="orderListItemFirstTR">
                    <td colspan="2">
                        <b><fmt:formatDate value="${o.create_date}" type="date"/></b>
                        <span>订单号: ${o.order_code}
                    </span>
                    </td>
                    <td colspan="2"><img width="13px" src="${pageContext.request.contextPath}/static/img/fore/orderItemTmall.png">天猫商场</td>
                    <td colspan="1">
